...
class WC_Companies_Admin_Order_Fields {
	...
	public function enqueue_scripts() {
    	...
    	if( $screen->id === 'shop_order' ) {
            ...
            wp_register_script( 'order-fields-js', WC_Companies()->plugin_url() . '/assets/js/admin/wc-companies-order-fields' . $suffix . '.js', array('jquery', 'wc-companies-admin-general'), '1.0.2', true );
